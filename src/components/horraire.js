...
export default function Horraire() {
...
return( 
<>
<h2 className="mb-20 m-auto text-xl text-center" > Horraire d’ouveture </h2>
    <section className="py-20 w-10/12 m-auto grid grid-cols-1 grid-rows-3 md:grid-cols-3 md:grid-rows-1 auto-cols-max auto-rows-max gap-y-20 gap-x-28 content-center">
